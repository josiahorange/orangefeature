...
//script enqueues
    ...
    function enqueue(){
        ...
        wp_enqueue_style('mypluginstyle', plugins_url( '/assets/orangefeatstyle.css', __FILE__), array(), false, 'all');
        wp_enqueue_script('mypluginscript', plugins_url( '/assets/orangefeatscript.js', __FILE__));
